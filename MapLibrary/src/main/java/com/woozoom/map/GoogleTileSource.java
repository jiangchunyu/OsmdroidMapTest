...
public class GoogleTileSource extends XYTileSource {
    ...
    public static final String GOOGLE_MAP_SATELLITE_URL =  "http://mt2.google.cn/vt/lyrs=y&gl=CN&x=%d&y=%d&z=%d";//普通地图
    public static final String GOOGLE_MAP_ROADURL = "http://mt2.google.cn/vt/lyrm=y&gl=CN&x=%d&y=%d&z=%d";//卫星地图
    //影像底图 lyrs=s  没有标注
    ...
    public GoogleTileSource() {
        super("Google", 1, 19, 256, "png", baseUrl_GoogleLabel);
    }
