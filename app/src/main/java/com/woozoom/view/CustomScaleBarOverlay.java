...
import osmdroidmaptest.osmdroidmaptest.R;
 ...
 * @datetime: 2018/1/29
 */
public class CustomScaleBarOverlay  extends Overlay implements GeoConstants {
    ...
    public CustomScaleBarOverlay(final MapView mapView) {
        super();
    ...
    private void drawLongitudeText(final Canvas canvas, final Projection projection) {
        ...
        Log.d("jiangcy", "drawLatitudeText: yMsg "+yMsg+"  yMetersAdjusted "+yMetersAdjusted);
